...
// .wrangler/tmp/bundle-aAvrv0/checked-fetch.js
...
// .wrangler/tmp/bundle-aAvrv0/strip-cf-connecting-ip-header.js
...
var data_default = {
  data: [
    ...
    },
    {
      ...
      readTime: 12,
      publishedAt: "2025-07-13T14:30:00.000Z"
    },
    {
      _id: 3,
...
// controllers/blogControllerWorker.js
var handleGetAllBlogs = /* @__PURE__ */ __name(async (c) => {
  try {
    const blogs = data_default.data;
    return c.json(blogs);
  } catch (error) {
    return c.json({ message: "Error fetching blogs", error: error.message }, 500);
  }
}, "handleGetAllBlogs");
var handleGetBlogById = /* @__PURE__ */ __name(async (c) => {
  try {
    const id = c.req.param("id");
    const blog = data_default.data.filter((item) => item._id === parseInt(id));
    return c.json(blog);
  } catch (error) {
    return c.json({ message: "Error fetching blog", error: error.message }, 500);
  }
}, "handleGetBlogById");
var handleCreateBlog = /* @__PURE__ */ __name(async (c) => {
  try {
...
// .wrangler/tmp/bundle-aAvrv0/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-aAvrv0/middleware-loader.entry.ts
