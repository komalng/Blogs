...
// .wrangler/tmp/bundle-0ZauZ6/checked-fetch.js
...
app.get("/test-db", async (c) => {
  try {
    const { results } = await c.env.DB.prepare("SELECT * FROM blogs LIMIT 1;").all();
...
// .wrangler/tmp/bundle-0ZauZ6/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-0ZauZ6/middleware-loader.entry.ts
